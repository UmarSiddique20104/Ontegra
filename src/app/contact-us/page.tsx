...
const ContactUs = () => {
	...
	const handleSubmit = async (e: any) => {
		...
		try {
			...
			formDatas.append('country', formData.country?.label || 'United Arab Emirates');
					...
					<div className='contactInfo relative z-10'>
						<div className="container mx-auto px-4">
							<div className="xl:flex -mx-4">
								<div className="px-4">
									<h1 className='font-montserrat font-bold text-black text-3xl md:text-5xl lg:text-6xl xl:text-[80px] xl:leading-[89px] -tracking-[0.96px] lg:mb-[70px] md:mb-9 mb-5'>REQUEST FOR PROPOSAL</h1>
											...
											<div className="contact-form">
												<form onSubmit={handleSubmit}>
													<div className="sm:flex sm:flex-wrap -mx-3">
														...
														<div className="sm:w-1/2 px-3 mb-7">
															<label htmlFor="country" className='flex items-center gap-2 text-black font-montserrat font-medium text-base leading-5 mb-2'>Your Nationality <span className=' text-red-600 font-bold text-xl h-5'>*</span></label>
															<Select
																options={COUNTRIES}
														...
														<div className="sm:w-full px-3">
															<label htmlFor="message" className='flex items-center gap-2 text-black font-montserrat font-medium text-base leading-5 mb-2'>Message <span className=' text-red-600 font-bold text-xl h-5'>*</span></label>
