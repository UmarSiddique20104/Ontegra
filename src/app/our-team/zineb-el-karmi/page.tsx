            ...
            <section className='pt-16'>
                <div className="bg-white px-4 pb-5 md:pb-0 lg:px-0">
                    <div className="container mx-auto px-4 3xl:py-[150px] lg:pt-[100px] pt-20 lg:pb-10">
                        <TeamDetailsContent title='Zineb El Karmi'
                            designation={"Regional Head – Dubai"}
                            description='Renowned for adeptly managing TFM contracts, Zineb leads Ontegra’s diverse teams across government, education, and commerce, continually elevating Dubai’s FM standards.'
                            description2={""}
                            description3={""}
                            imageUrl='/team/ZinebElKarmi.jpg' buttonTitle='Discover Our Legacy'
                        />
                    </div>
                </div>
            </section>
