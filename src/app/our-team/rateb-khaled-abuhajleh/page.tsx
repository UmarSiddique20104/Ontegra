            ...
            <section className='pt-16'>
                <div className="bg-white px-4 pb-5 md:pb-0 lg:px-0">
                    <div className="container mx-auto px-4 3xl:py-[150px] lg:pt-[100px] pt-20 lg:pb-10">
                        <TeamDetailsContent title='Rateb Khaled AbuHajleh'
                            designation={"IT Manager"}
                            description='With over 16 years in IT solutions, Rateb drives technological innovation at Ontegra, expertly aligning IT operations with business strategy for robust infrastructure.'
                            description2={""}
                            description3={""}
                            imageUrl='/team/RatebKhaledAbuHajleh.jpg' buttonTitle='Discover Our Legacy'
                        />
                    </div>
                </div>
            </section>
