            ...
            <section className='pt-16'>
                <div className="bg-white px-4 pb-5 md:pb-0 lg:px-0">
                    <div className="container mx-auto px-4 3xl:py-[150px] lg:pt-[100px] pt-20 lg:pb-10">
                        <TeamDetailsContent title='Ahmed Wahdan Abdel Samad'
                            designation={"HR Manager"}
                            description='Ahmed’s strategic HR leadership over 14 years has spanned the MENA and GCC, innovating Ontegra’s HR operations and aligning them with strategic corporate goals.'
                            description2={""}
                            description3={""}
                            imageUrl='/team/AhmedWahdanAbdelSamad.jpg' buttonTitle='Discover Our Legacy'
                        />
                    </div>
                </div>
            </section>
