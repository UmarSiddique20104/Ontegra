            ...
            <section className='pt-16'>
                <div className="bg-white px-4 pb-5 md:pb-0 lg:px-0">
                    <div className="container mx-auto px-4 3xl:py-[150px] lg:pt-[100px] pt-20 lg:pb-10">
                        <TeamDetailsContent title='Anand Bhardwaj'
                            designation={"Soft Services Manager"}
                            description='Anand, with over 30 years’ experience including two decades in the UAE, delivers high-performance soft services at Ontegra, with past roles in BK Gulf and Emrill.'
                            description2={""}
                            description3={""}
                            imageUrl='/team/AnandBhardwaj.jpg' buttonTitle='Discover Our Legacy'
                        />
                    </div>
                </div>
            </section>
