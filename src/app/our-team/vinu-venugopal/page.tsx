            ...
            <section className='pt-16'>
                <div className="bg-white px-4 pb-5 md:pb-0 lg:px-0">
                    <div className="container mx-auto px-4 3xl:py-[150px] lg:pt-[100px] pt-20 lg:pb-10">
                        <TeamDetailsContent title='Vinu Venugopal'
                            designation={"Business Development Manager"}
                            description='Vinu’s 23-year FM career, punctuated with strategic roles across major UAE projects, propels Ontegra’s growth through expert business development.'
                            description2={""}
                            description3={""}
                            imageUrl='/team/VinuVenugopal.jpg' buttonTitle='Discover Our Legacy'
                        />
                    </div>
                </div>
            </section>
