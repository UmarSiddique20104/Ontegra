            ...
            <section className='pt-16'>
                <div className="bg-white px-4 pb-5 md:pb-0 lg:px-0">
                    <div className="container mx-auto px-4 3xl:py-[150px] lg:pt-[100px] pt-20 lg:pb-10">
                        <TeamDetailsContent title='Anthony Richard Rodrigues'
                            designation={"Procurement Manager"}
                            description="Anthony’s expertise in procurement and material management maximizes Ontegra’s operational efficiency and aligns purchasing strategies with fiscal directives."
                            description2={""}
                            description3={""}
                            imageUrl='/team/AnthonyRichardRodrigues.jpg' buttonTitle='Discover Our Legacy'
                        />
                    </div>
                </div>
            </section>
