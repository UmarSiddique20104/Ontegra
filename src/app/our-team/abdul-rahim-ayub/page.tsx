            ...
            <section className='pt-16'>
                <div className="bg-white px-4 pb-5 md:pb-0 lg:px-0">
                    <div className="container mx-auto px-4 3xl:py-[150px] lg:pt-[100px] pt-20 lg:pb-10">
                        <TeamDetailsContent title='Abdul Rahim Ayub'
                            designation={"QHSE – Head of service"}
                            description='Abdul Rahim champions QHSE protocols at Ontegra, embedding a culture of safety and ensuring regulatory compliance across high-profile client venues.'
                            description2={""}
                            description3={""}
                            imageUrl='/team/AbdulRahimAyub.jpg' buttonTitle='Discover Our Legacy'
                        />
                    </div>
                </div>
            </section>
