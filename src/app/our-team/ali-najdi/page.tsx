            ...
            <section className='pt-16'>
                <div className="bg-white px-4 pb-5 md:pb-0 lg:px-0">
                    <div className="container mx-auto px-4 3xl:py-[150px] lg:pt-[100px] pt-20 lg:pb-10">
                        <TeamDetailsContent title='Ali Najdi'
                            designation={"HVAC Service Manager"}
                            description='Ali leads Ontegra’s HVAC services with over thirteen years’ engineering experience, ensuring peak mechanical system performance and project excellence.'
                            description2={""}
                            description3={""}
                            imageUrl='/team/AliNajdi.jpg' buttonTitle='Discover Our Legacy'
                        />
                    </div>
                </div>
            </section>
