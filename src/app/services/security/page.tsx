...
import securityServices from "../../../../public/services/SecurityServices.png";
          ...
          <div className="grid grid-cols-12 lg:gap-x-[80px] lg:gap-y-0 gap-y-5">
            <div className="lg:col-span-9 col-span-12 lg:pt-[100px] pt-[30px]">
              ...
              <p className="2xl:mt-[80px] xl:mt-[50px] lg:mt-9 font-lato max-sm:text-[16px] 3xl:text-[22px] xl:text-[20px] md:text-[18px] font-normal text-[#707070] 2xl:leading-[40px] xl:leading-[30px] xl:max-w-[89%]">
                At Ontegra, our Security Services division is steadfast in
                offering uncompromised safety and security for our clients
                across various sectors. Our approach combines the robustness of
                SIRA-approved protocols with the adaptability needed in today’s
                diverse operational landscapes.
              </p>
            </div>
            <div
              className="lg:col-span-3 col-span-12 md:mx-auto  lg:mx-0 mx-0 max-sm:mt-3 max-lg:mt-6 max-xl:mt-7
						max-2xl:mt-6 max-lg:mb-11 max-lg:w-full max-lg:h-fit"
            >
              <Image
      ...
      <section className="container mx-auto px-4">
        ...
        <div className="lg:my-[100px] 2xl:mb-[200px] my-9">
          <div className="2xl:w-[80%] xl:w-[55%] lg:w-[68%]">
            <h2 className="font-lato font-bold  md:text-[30px] text-[24px]">
