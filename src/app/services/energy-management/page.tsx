...
import energyManagement from "../../../../public/services/EnergyManagement.png";
			...
			<section className='container mx-auto px-4'>
				<div className="pt-28 pb-10 lg:pb-32 xl:pb-52">
					<div className="grid grid-cols-12 md:gap-x-10 lg:gap-x-[80px] lg:gap-y-0 gap-y-5">
						...
						<h1 className='font-montserrat font-bold text-black text-3xl md:text-5xl lg:text-6xl xl:text-[80px] xl:leading-[89px] -tracking-[0.96px] mb-2'>Energy Management</h1>
							<p className='2xl:text-[40px] xl:text-[30px] lg:text-[25px] md:text-[22px] text-[18px] font-normal font-montserrat text-[#278CB3] my-5 lg:my-0'>Optimizing Efficiency, Maximizing Sustainability</p>
							<p className='2xl:mt-[80px] xl:mt-[50px] lg:mt-9 font-lato max-sm:text-[16px] 3xl:text-[22px] xl:text-[20px] md:text-[18px] font-normal text-[#707070] 2xl:leading-[40px] xl:leading-[30px] xl:max-w-[89%]'>Ontegra leads the charge in sustainable energy management within the facilities management industry. Our commitment is to not only ensure operational efficiency but also to drive sustainability efforts that contribute to a healthier planet.</p>
						</div>
			...
			<section className='container mx-auto px-4'>
				...
				<div className="lg:my-[100px] xl:mb-[200px] my-7">
					<div className="w-full">
						<p className='font-lato font-bold text-black text-[30px] leading-[40px] mb-10'>With Ontegra, security is more than a service—it’s a promise</p>
						<p className='font-lato font-normal text-black  text-[30px] leading-[40px]'>A promise to deliver peace of mind with vigilance, expertise, and unwavering dedication to the safety of our clients’ facilities and their occupants.</p>
					</div>
				</div>
			</section>
