...
import specializedServices from "../../../../public/services/SpecializedServices.png";
        ...
        <div className="pt-[110px] min-h-screen">
          <div className="grid grid-cols-12 lg:gap-x-[80px] lg:gap-y-0 gap-y-5">
            <div className="lg:col-span-9 col-span-12 lg:pt-[100px] pt-[30px]">
              ...
              <p className="2xl:mt-[80px] xl:mt-[50px] lg:mt-9 font-lato 3xl:text-[22px] xl:text-[20px] max-sm:text-[16px] md:text-[18px] font-normal text-[#707070] 2xl:leading-[40px] xl:leading-[30px] xl:max-w-[89%]">
            ...
            <div
              className="lg:col-span-3 col-span-12 md:mx-auto lg:mx-0 mx-0 max-sm:mt-3 max-lg:mt-6 max-xl:mt-6
						max-2xl:mt-6 max-lg:mb-11 max-lg:w-full max-lg:h-fit"
            >
              <Image
                src={specializedServices}
